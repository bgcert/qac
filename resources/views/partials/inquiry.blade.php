                    ...
                    <form>
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item col-6">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Маркировка CE</a>
                            </li>
                            <li class="nav-item col-6">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Системи за управление</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea1">Какво е неговото предназначение</label>
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                    <small id="emailHelp" class="form-text text-muted">* Информацията е необходима за прецизното определяне на директивите, в които попада</small>
                                </div>
                            </div>
